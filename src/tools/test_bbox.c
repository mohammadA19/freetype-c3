...
#else
    { (int)0x0198E93DL , (int)0x021750FFL },  /* 408.9111, 535.3164 */
    { (int)0x01C7E312L , (int)0x027A6560L },  /* 455.8887, 634.3960 */
    { (int)0xFFDA1F9EL , (int)0x0312387FL },  /* -37.8765, 786.2207 */
    { (int)0x00A49B7EL , (int)0x021750FFL }   /* 164.6074, 535.3164 */
#endif
   };
