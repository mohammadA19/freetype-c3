...
FT_BEGIN_HEADER
  ...
  typedef struct  TT_HoriHeader_
  {
    ...
    ushort  advance_Width_Max;      /* advance width maximum */

    short   min_Left_Side_Bearing;  /* minimum left-sb       */
    short   min_Right_Side_Bearing; /* minimum right-sb      */
    short   xMax_Extent;            /* xmax extents          */
  ...
  typedef struct  TT_OS2_
  {
    ...
    ushort  usLowerOpticalPointSize;       /* in twips (1/20 points) */
    ushort  usUpperOpticalPointSize;       /* in twips (1/20 points) */
